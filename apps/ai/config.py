...
AI_CUDA_DEVICE = int(os.getenv("AI_CUDA_DEVICE", "0"))
AI_ONNX_PROVIDER = os.getenv("AI_ONNX_PROVIDER", "auto")

YOLO_MODEL = os.getenv("YOLO_MODEL", "yolov8n.pt")
YOLO_CONFIDENCE_THRESHOLD = float(os.getenv("YOLO_CONFIDENCE_THRESHOLD", "0.5"))
INFERENCE_FPS = float(os.getenv("INFERENCE_FPS", "0"))
CPU_INFERENCE_FPS = float(os.getenv("CPU_INFERENCE_FPS", "5"))
GPU_INFERENCE_FPS = float(os.getenv("GPU_INFERENCE_FPS", "10"))
WARMUP_FRAME_WIDTH = int(os.getenv("WARMUP_FRAME_WIDTH", "1280"))
WARMUP_FRAME_HEIGHT = int(os.getenv("WARMUP_FRAME_HEIGHT", "720"))
